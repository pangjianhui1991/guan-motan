...
@EnableCaching
public class GuanMotanServerApplication {
	private static final Logger log = LoggerFactory.getLogger(GuanMotanServerApplication.class);
	...
	public static void main(String[] args) throws UnknownHostException {
		...
		//SpringApplication.run(GuanMotanServerApplication.class, args);
		SpringApplication app = new SpringApplication(GuanMotanServerApplication.class);
